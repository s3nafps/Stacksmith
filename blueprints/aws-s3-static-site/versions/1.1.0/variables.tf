...
variable "domain_name" {
  description = "Custom domain name for the CloudFront distribution (e.g., www.example.com). When provided, an ACM certificate is created."
  type        = string
  default     = ""
}
...
variable "cloudfront_price_class" {
  description = "The CloudFront price class that determines edge location coverage."
  type        = string
